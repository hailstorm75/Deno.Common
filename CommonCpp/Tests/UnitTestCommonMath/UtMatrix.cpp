...
TEMPLATE_TEST_CASE("Class can be initialized with given size", "[Constructor][Template]", unsigned short, unsigned, unsigned long, short, int, long)
{
  REQUIRE_NOTHROW(Matrix<TestType>(5, 3));
}

TEMPLATE_TEST_CASE("Class can be initialized from given array", "[Constructor][Template]", unsigned short, unsigned, unsigned long, short, int, long)
{
...
TEMPLATE_TEST_CASE("Class won't initialize with invalid size.", "[Constructor][Template]", unsigned short, unsigned, unsigned long, short, int, long)
{
