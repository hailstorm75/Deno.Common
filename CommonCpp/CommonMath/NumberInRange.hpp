...
namespace Common
{
  namespace Math
  {
    ...
    public:
      ...
      {
        return AdjustValue(m_value + AdjustValue(other, m_min, m_max));
      }
      T operator +(const NumberInRange<T> & other) noexcept
      {
        return AdjustValue(m_value + AdjustValue(other.m_value, m_min, m_max));
      }
      ...
      T operator /(const NumberInRange<T> & other)
      {
        return AdjustValue(m_value / AdjustValue(other.m_value, m_min, m_max));
      }
